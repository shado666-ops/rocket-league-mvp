...
# --- CONFIGURATION ---
# URL du tracker (localhost par défaut, à changer pour l'URL Render en prod)
TRACKER_URL = os.getenv("TRACKER_URL", "http://127.0.0.1:8000")

# API Local du tracker
API_UPLOAD_URL = f"{TRACKER_URL}/api/matches/upload"
API_UPLOAD_CSV_URL = f"{TRACKER_URL}/api/matches/upload_csv"
